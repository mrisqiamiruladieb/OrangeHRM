...
public class DeletePayGrade extends env_target {
    ...
    public void main(){
        ...
        wait.until(
                ExpectedConditions.and(
                        ...
                        ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div/div[3]/div/div[2]/div[1]/div/div[4]/div/button[1]"))
                )
        );
        //Set element locate
        //Click delete button
    ...
    @Test //Delete the selected pay grade success
    public void delete2(){
        //Set driver location path
        System.setProperty("webdriver.chrome.driver","src\\main\\resources\\drivers\\chromedriver.exe");
        //Maximize driver
