...
public class AddStructure01 extends env_target {
    ...
    public void main(){
        ...
        //Set case stop tunggu
        wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div/div[3]/ul/li/ul/li[2]/div[1]/div/div/div[2]/button[3]"))
        );
        //Set element locate
        //Click on the add 1 button
        driver.findElement(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div/div[3]/ul/li/ul/li[2]/div[1]/div/div/div[2]/button[3]")).click();
        //Set case stop tunggu
        wait.until(
                ExpectedConditions.and(
        ...
        //Set element locate
        //Input unit id
        driver.findElement(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div[2]/div/div/div/form/div[1]/div/div[2]/input")).sendKeys("tes_id_01");
        //Input name
        driver.findElement(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div[2]/div/div/div/form/div[2]/div/div[2]/input")).sendKeys("add_name_01");
        //Input description
        driver.findElement(By.xpath("//textarea[@placeholder='Type description here']")).sendKeys("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque semper.");
        //Click save button
