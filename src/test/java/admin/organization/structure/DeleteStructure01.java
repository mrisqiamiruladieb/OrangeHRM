...
public class DeleteStructure01 extends env_target {
    ...
    public void main() {
        ...
        //Set case stop tunggu
        wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div/div[3]/ul/li/ul/li[2]/div[1]/div/div/div[2]/button[1]"))
        );
        //Set element locate
        //Click on the delete 1 button
        driver.findElement(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div/div[3]/ul/li/ul/li[2]/div[1]/div/div/div[2]/button[1]")).click();
        //Set case stop tunggu
        wait.until(
                ExpectedConditions.and(
