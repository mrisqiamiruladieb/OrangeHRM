...
public class EditStructure01 extends env_target {
    ...
    public void main(){
        ...
        //Set case stop tunggu
        wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div/div[3]/ul/li/ul/li[2]/div[1]/div/div/div[2]/button[2]"))
        );
        //Set element locate
        //Click on the edit 1 button
        driver.findElement(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div/div[3]/ul/li/ul/li[2]/div[1]/div/div/div[2]/button[2]")).click();
        //Set case stop tunggu
        wait.until(
                ExpectedConditions.and(
        ...
        nameActions.click(driver.findElement(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div[2]/div/div/div/form/div[2]/div/div[2]/input")))
                .keyDown(Keys.CONTROL).sendKeys("a").keyUp(Keys.CONTROL).sendKeys(Keys.BACK_SPACE).sendKeys("edit_name_01_ok")
                .build().perform();
        //Click save button
